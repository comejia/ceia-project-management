...
El proyecto incluye:
\begin{itemize}
	\item Recolección y procesamiento de \textit{dataset} públicos para generar el histórico de los usuarios.
...
\begin{itemize}
	...
	\item De ser necesario, se evaluará el uso de recursos en la nube.
	\item El responsable dedicará el tiempo suficiente para cumplir con la planificación establecida.
	\item Se utilizará herramientas \textit{open source}
\end{itemize}
